  ...
  return (
    <nav className='bg-gradient-to-r from-gray-900 to-gray-800 h-15 flex flex-row justify-center items-center text-lg sticky top-0 z-50'>
      <div className='flex justify-between items-center h-20 max-w-screen-xl mx-auto w-full px-0'>
        <Link  className='text-white text-2xl font-bold cursor-pointer p-2 m-2' onClick={closeMobileMenu}>
        ...
        <ul className={`lg:flex lg:items-center lg:space-x-6 ${click ? 'flex flex-col items-center justify-start absolute top-20 left-0 bg-gray-800 w-full h-[90vh]' : 'hidden lg:flex'}`}>
         <li className='h-20'>
          ...
          <li className='h-20'>
            <Link to='/MyHostels' className='text-white flex items-center px-4 py-2 h-full hover:border-b-4 hover:border-white' onClick={closeMobileMenu}>
              My Hostels
            </Link>
          </li>
          <li className='h-20'>
            <Link to='/AddHostel' className='text-white flex items-center px-4 py-2 h-full hover:border-b-4 hover:border-white' onClick={closeMobileMenu}>
              Add Hostel
            </Link>
          </li>
            ...
            {isOpen && (
              <div className='absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg'>
                  ...
                  <>
                    ...
                    <Link to='/LandlordProfile' className='block px-4 py-2 text-gray-800 hover:bg-gray-100' onClick={closeMobileMenu}>
                      My Profile
                    </Link>
        ...
        <Link to='/LandlordNotification' className='p-0 m-0 '>
